...
> **Provenance.** Vendored from Evolver (`GIT_GUIDELINES.md`, identical to jMetal's) as of
> 2026-07-23, with the pre-commit build/test example generalized for MOLA's Python + Java codebase.
> Keep in sync with upstream Evolver/jMetal: edit there first, then re-vendor here.
...
- Ensure the project builds and all tests pass before committing (Python core: `pytest` / `make lint`; Java adapter: `mvn clean test`).
