...
> **Provenance.** Vendored verbatim from jMetal/Evolver (`JAVA_CODING_GUIDELINES.md`, identical in
> both repos as of 2026-07-23). Applies to MOLA's Java code — the jMetal (Java) sampling adapter.
> Keep in sync with upstream jMetal/Evolver: edit there first, then re-vendor here.
